		...
		<div class="row">
			...
			<div class="col-sm-4">
				<div class="panel panel-primary">
					<div class="panel panel-heading">Estoque ValleRace</div>
					<div class="panel panel-body">
						<p>
							<img src="img/vallerace.png"  width="100%">
						</p>
						<form id="frmLogin">
							<label>Email</label>
		...
		$.ajax({
			...
			success:function(r){
				...
				if(r==1){
					...
					alert("Acesso Negado, Entre me contato com administrador do sistema!!");
				}
			}
		});
	});
